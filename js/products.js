...
const STORE_SETTINGS = {
  ...
  // --- PAYMENTS: PUT YOUR OWN USERNAME HERE -----------------------------
  // PayPal:  create a link at https://paypal.me  -> put the username here
  paypalUsername: "WatersideShop",

  // --- DELIVERY FEE ------------------------------------------------------
  // Every order is local delivery (no collection option), so a fee is
  // added to every order total automatically. The fee is tiered by basket
  // item count (see currentDeliveryFee() in js/main.js): 1 item = €2,
  // 2 or more items = €3 flat. This setting is no longer used directly —
  // edit the tiers in main.js instead.
  deliveryFee: 5.00,
...
const DRINKS = [
  ...
  {
    id: "d6",
    name: " Mega Monster Energy Original 553ml",
    price: 2.95,
    stock: 4,
...
const MERCH = [
  {
    ...
    price: 20.00,
    stock: 6,
    description: "Available in sizes 12–13, Small, Medium. Please leave a note with your preferred size, otherwise Medium will be sent.",
    images: [
  ...
  },
  {
    ...
    price: 20.00,
    stock: 9,
    description: "Available in sizes 12–13, Small, Medium. Please leave a note with your preferred size, otherwise Medium will be sent. BASIC is my own skate clothing brand. I designed these shirts myself using CorelDRAW. Thanks for supporting my small business!",
    images: [
